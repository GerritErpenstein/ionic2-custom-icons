...
```
The library has been tested with Ionic 3.9.2, @ionic/app-scripts 3.1.0 and ionic-cli 3.19.1.
```
...
Take a look [here](#example-app) to find a working example app to start right away. :rocket:
